...
internal sealed record BotBrain(
    ...
    int MaxWeaponBuy,
    /// <summary>
    /// How many times its own fare a pile has to be worth before this personality banks it.
    ///
    /// A multiple rather than a sum of money, because a trip to the bank costs turns and turns are
    /// worth whatever the crew earns with them. The flat figures this replaced were tuned when
    /// banking was free: every one of them was pocket change to a full house, so a grown rival
