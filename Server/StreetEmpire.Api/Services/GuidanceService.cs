    ...
    public IReadOnlyList<NextMoveResponse> NextMoves(Player player, double heat, HeldCrew? held = null)
    {
        ...
        if (held is { Heads: > 0 })
        {
            ...
            Add(5, $"Bail out {held.Heads:N0} of your crew",
                ...
                GuidancePages.Crew, held.TotalBail);
        }
        ...
        if (unmanaged > 0)
        {
            Add(11, "Hire a pimp",
                ...
                GuidancePages.Crew, _options.Crew.HirePimpCost);
        }
        ...
        if (player.Condoms < report.CondomsNeededForMaxStreetAction || player.Beer < report.BeerNeededForMaxStreetAction)
        {
            Add(12, "Restock supplies",
                ...
                GuidancePages.Market, report.SupplyCostForMaxStreetAction);
        }
        ...
        if (morale < _options.Morale.DesertionThreshold + 15)
        {
            Add(13, "Give the crew a night off",
                ...
                GuidancePages.Crew, _options.Morale.HqRestCashPerCrew * (player.Pimps + player.Hoes + player.Thugs));
        }
            ...
            && economy.CalculatePlunder(player) >= _options.AntiFarm.MinDefenderNetWorth)
        {
            ...
            if (crates > 0)
                Add(32, $"Buy {crates:N0} crate{(crates == 1 ? string.Empty : "s")} of medicine",
                    ...
                    GuidancePages.Market, (long)crates * _options.MedicinePrice);
        }
    ...
    public IReadOnlyList<ObjectiveResponse> Objectives(Player player, IReadOnlyCollection<string> actionsTaken)
    {
        ...
        [
            ...
            Step("Bank what you make", "Cash on hand is stolen in a raid. Cash in the bank is not, and the "
                ...
                GuidancePages.Market, actionsTaken.Contains("BANK")),
